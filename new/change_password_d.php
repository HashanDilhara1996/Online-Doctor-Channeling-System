...
if(isset($_POST['submit'])){
    ...
    $password=$_POST['password'];
		...
		if(empty($errors)){
			...
			$sql = "UPDATE doctor SET password='{$password}' WHERE id={$user_id} LIMIT 1";
...
<div class="container">
  ...
  <div class="form-group">
    ...
    <form action="change_password_d.php" method="post">
     <input type="hidden" name="user_id" value="<?php echo $user_id   ?>">
      ...
      <input type="text" name="speciality" placeholder="Enter Speciality"class="form-control" <?php echo 'value="'. $speciality .'"'; ?>disabled>
      <br>
      <label>New Password :</label>
      <input type="password" name="password" placeholder="Enter The New Password"class="form-control">
  <br>
  <label>Show Password :</label>
      <input type="checkbox" name="showpassword" id="showpassword" class="form-control" style="width:20px;height:20px">
...
<a  class="button" href="modify_doctor.php"> Back</a>
